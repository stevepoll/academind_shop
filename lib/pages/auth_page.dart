...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (serverError.contains('EMAIL_EXISTS')) {
        errorMessage = 'This email is already in use.';
      } else if (serverError.contains('INVALID_EMAIL')) {
        errorMessage = 'This is not a valid email address.';
      } else if (serverError.contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'Could not find a user with that email address.';
      } else if (serverError.contains('INVALID_PASSWORD')) {
